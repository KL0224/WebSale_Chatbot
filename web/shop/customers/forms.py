...
class CustomerRegisterForm(FlaskForm):
    ...
    email = StringField('Email', validators=[validators.Email(message='Email không hợp lệ'), validators.DataRequired(), validators.Length(min=6, max=35, message="Email độ dài từ 6 đến 35 ký tự")])
